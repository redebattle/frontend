        ...
        <div className="flex lg:flex-row sm:flex-col mt-8 px-6">
          ...
          <div className='flex flex-col mr-6 w-full'>
            ...
            <div className='mt-4 w-full bg-recent-donations-image backdrop-blur-md border-b-4 border-black rounded-lg p-4 lg:ml-5 sm:ml-0 sm:mt-3'>
              <div className='p-2'>
                <h1 className='flex flex-col items-center lg:text-xl sm:text-lg font-bold'><FaShoppingCart className='lg:text-4xl sm:text-2xl' />ÚLTIMAS COMPRAS</h1>
                <p className='text-center lg:text-base sm:text-sm'>Estes são os últimos jogadores que adquiriram produtos em nossa loja.</p>
              </div>
