          ...
          <div className="flex flex-col mr-6 w-full">
            ...
            <div className="mt-3 w-full bg-dark2 border-b-4 border-black rounded-lg p-5 mr-5 mb-3">
              <text>
                ...
                - Acesso á 10% de desconto no /spawners <br />- Acesso á receber
                10% a mais de coins em drop da maquina. <br />
                - Acesso ao comando /armazem para ver informações da sua maquina
                sem ir nela. <br />
                - Acesso ao shift sem delay no /vender (players sem VIP possuem
                entre 15s - 5s de delay) <br />
              </text>
            </div>
          </div>
