    ...
    <>
      ...
      <div className="flex flex-row items-center justify-between bg-dark2 border-b-4 border-black rounded-lg mt-5 mx-3 p-4">
        <div className="flex flex-row items-center">
          ...
          <span class="ml-2 badge badge-outline text-instagram_grad_8 font-bold">
            Baixo
          </span>
        </div>
        <button
      ...
      <div className="flex lg:flex-row sm:flex-col">
        <div className="flex flex-col max-w-lg">
          <div className="bg-dark2 border-b-4 border-black rounded-lg mt-5 mx-3 p-4">
            ...
            <p className="p-3">
              <b>Status:</b> Respondido
            </p>
            <p className="p-3 flex flex-col">
              <b>Última atualização:</b> 00/00/0000 às 00:00:00
            </p>
            <p className="p-3 flex flex-col">
              <b>Criado em:</b> 00/00/0000 às 00:00:00
            </p>
          </div>
          <div className="bg-dark2 border-b-4 border-black rounded-lg mt-5 mx-3 p-4">
            <h1 className="text-center font-bold text-xl p-2">
                  ...
                  <div className="flex flex-row">
                    <div className="bg-roxo p-4 rounded-lg">
                      <p>
                        ...
                        elit. Voluptatem, facere maxime! Expedita illo ipsam
                        veniam possimus architecto, optio ea eaque aspernatur
                        totam, vitae culpa aliquid quo incidunt! Assumenda,
                        ipsum porro.
                      </p>
                    </div>
                    <img
